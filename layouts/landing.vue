    ...
    <header class="sticky top-0 z-50 border-b border-[rgb(var(--color-border))] bg-[rgb(var(--color-background))]">
      <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex items-center gap-2 sm:gap-4">
          <!-- Desktop nav links -->
          <NuxtLink to="/recruiter" class="plausible-event-name=Nav-Recruiter hidden rounded-md px-3 py-2 text-sm font-semibold text-[rgb(var(--color-recruiter))] transition-colors hover:bg-[rgb(var(--color-recruiter)/0.12)] hover:text-[rgb(var(--color-recruiter-dark))] sm:block">
            For Recruiters
          </NuxtLink>
          <NuxtLink to="/institutions" class="plausible-event-name=Nav-Institutions hidden rounded-md px-3 py-2 text-sm font-semibold text-[rgb(var(--color-institution))] transition-colors hover:bg-[rgb(var(--color-institution)/0.12)] hover:text-[rgb(var(--color-institution-dark))] sm:block">
            For Institutions
          </NuxtLink>
          <!-- Mobile hamburger -->
          <button
        ...
        >
          ...
          <nav class="mobile-drawer absolute right-0 top-0 flex h-full w-72 flex-col bg-[rgb(var(--color-background))] shadow-2xl">
            ...
            <div class="flex-1 overflow-y-auto px-3 py-4">
              <NuxtLink
                to="/recruiter"
                class="plausible-event-name=Nav-Recruiter flex items-center gap-3 rounded-lg px-3 py-3 text-[0.9375rem] font-semibold text-[rgb(var(--color-recruiter))] transition-colors hover:bg-[rgb(var(--color-recruiter)/0.12)]"
                @click="closeMobileMenu"
              >
              ...
              <NuxtLink
                to="/institutions"
                class="plausible-event-name=Nav-Institutions flex items-center gap-3 rounded-lg px-3 py-3 text-[0.9375rem] font-semibold text-[rgb(var(--color-institution))] transition-colors hover:bg-[rgb(var(--color-institution)/0.12)]"
                @click="closeMobileMenu"
              >
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
      ...
      <div class="mx-auto max-w-7xl px-4 py-10 sm:py-16 sm:px-6 lg:px-8">
        ...
        <div class="mb-12 text-center">
          ...
          <div class="mt-6 flex items-center justify-center gap-4">
            <a href="https://github.com/ifftu-dev/alexandria" target="_blank" rel="noopener noreferrer" class="plausible-event-name=CTA-GitHub rounded-full p-2 text-[rgb(var(--color-muted-foreground))] transition-colors hover:bg-[rgb(var(--color-background))] hover:text-[rgb(var(--color-foreground))]" aria-label="GitHub">
            ...
            <a href="https://x.com/Alexandria_FTU" target="_blank" rel="noopener noreferrer" class="rounded-full p-2 text-[rgb(var(--color-muted-foreground))] transition-colors hover:bg-[rgb(var(--color-background))] hover:text-[rgb(var(--color-foreground))]" aria-label="Twitter">
              <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
