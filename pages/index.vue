    ...
    <section ref="heroRef" class="landing-hero relative flex min-h-[calc(90vh-4rem)] items-center justify-center overflow-hidden">
      ...
      <div class="container relative py-12">
        <div class="mx-auto max-w-5xl">
          ...
          <div class="landing-reveal landing-reveal-delay-3 mx-auto mt-10 max-w-xl rounded-xl border border-amber-500/40 bg-amber-100/80 px-5 py-4 backdrop-blur-sm dark:border-amber-400/20 dark:bg-amber-500/5">
            <p class="text-sm leading-relaxed text-amber-950 dark:text-amber-200/90">
              <span class="mr-1.5 font-semibold text-amber-800 dark:text-amber-300">Early Preview</span>
    ...
    <section class="relative overflow-hidden py-16 sm:py-24 lg:py-32">
      ...
      <div class="relative z-10 mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
        <div class="landing-scroll-reveal">
          ...
          <div class="mx-auto mt-6 max-w-md rounded-xl border border-amber-500/40 bg-amber-100/80 px-4 py-3 backdrop-blur-sm dark:border-amber-400/20 dark:bg-amber-500/5">
            <p class="text-sm leading-relaxed text-amber-950 dark:text-amber-200/90">
              <span class="mr-1 font-semibold text-amber-800 dark:text-amber-300">Early Preview</span>
