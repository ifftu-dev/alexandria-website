...
useHead({
  ...
  meta: [
    ...
    { property: 'og:image', content: 'https://alexandria.ifftu.dev/og/trust.jpg' },
    { property: 'og:image:alt', content: 'Trust — what we can claim today.' },
    { name: 'twitter:image', content: 'https://alexandria.ifftu.dev/og/trust.jpg' },
    { name: 'twitter:image:alt', content: 'Trust — what we can claim today.' },
